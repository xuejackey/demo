...
class NLPTask(Enum):
    ...
    WSD = 'wsd'
    protocol = 'protocol'
    protocol_c4r = 'protocol_c4r'
    I2B2 = 'i2b2'
    I2B2_2012 = 'i2b2_2012'
    I2B2_2014 = 'i2b2_2014'
    ShARe_2013 = 'ShARe_2013'
    
    BC2GM = 'BC2GM-IOBES'
    BC5CDR = 'BC5CDR-IOBES'
    BC4CHEMD = 'BC4CHEMD-IOBES'
    NCBI = 'NCBI-disease-IOBES'
    JNLPBA = 'JNLPBA-IOBES'
...
class NLPTaskDataFetcher:
    ...
    def fetch_data(task: NLPTask, base_path: Path = None) -> TaggedCorpus:
        ...
        data_folder = str(base_path / str(task.value))

        log.info("Reading data from {}".format(data_folder))
        #I2b2 NLP ner task has two columns
        if task == NLPTask.protocol:
    ...
    def fetch_column_corpus(
        ...
        if dev_file is not None:
            ...
            sentences_dev: List[Sentence] = [sentences_train[i] for i in NLPTaskDataFetcher.sample(len(sentences_train))]
            sentences_train = [x for x in sentences_train if x not in sentences_dev]
    ...
    def sample(length):
        import random
        samples = [x for x in range(1, length)]
